  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-12 flex items-center justify-between">
        <div className="flex-1">
          <h1 className="text-4xl font-bold mb-4">
            ...
            <br />
            <span className="text-slate-100">for Developers</span>
          </h1>
      ...
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-xl font-semibold text-slate-100">Popular Tools</h2>
        <Link
          to="/all"
        ...
        {popularTools.map((tool) => {
          ...
          return (
            <Link
              key={tool.id}
              to={tool.path}
              className="group bg-gray-900 border border-white/[0.06] rounded-xl p-4 hover:border-white/20 hover:scale-[1.02] transition-all duration-200 cursor-pointer"
            >
